  ...
  return (
    <NavigationContainer>
      <Stack.Navigator initialRouteName="Login">
        ...
        {/* Order screens here to define the navigation order */}
        <Stack.Screen name="TelaInicialUsuario" component={TelaInicialUsuario} options={{ headerLeft: () => (
      <Button title="Voltar" onPress={() => navigation.goBack()} />
      ), headerShown: false, headerTransparent: true, title: null }} />
